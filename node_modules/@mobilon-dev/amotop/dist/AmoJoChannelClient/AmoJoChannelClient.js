...
var AmoJoChannelClient = (function () {
    ...
    AmoJoChannelClient.prototype.disconnectChannel = function (account_id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.sendRequest('DELETE', "".concat(this.channelId, "/disconnect"), { data: { account_id: account_id } })];
                    case 1: return [2, _a.sent()];
                }
            });
        });
