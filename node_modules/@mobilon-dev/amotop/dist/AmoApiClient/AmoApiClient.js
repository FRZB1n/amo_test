...
var AmoApiClient = (function () {
    ...
    AmoApiClient.prototype.getWebhooks = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.axios.get('/api/v4/webhooks')];
    ...
    AmoApiClient.prototype.setWebhook = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.axios.post('/api/v4/webhooks', {
    ...
    AmoApiClient.prototype.deleteWebhook = function (_a) {
        return __awaiter(this, arguments, void 0, function (_b) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4, this.axios.delete('/api/v4/webhooks', {
                            data: {
    ...
    AmoApiClient.prototype.getUsers = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.axios.get('/api/v4/users')];
                    case 1: return [2, (_a.sent()).data];
                }
            });
        });
    ...
    AmoApiClient.prototype.getLeadLinks = function (leadId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = "/api/v4/leads/".concat(leadId, "/links");
                        return [4, this.axios.get(url)];
                    case 1: return [2, (_a.sent()).data];
                }
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        url = "/api/v4/contacts/".concat(contactId, "/links");
                        return [4, this.axios.get(url)];
                    case 1: return [2, (_a.sent()).data];
                }
            });
    ...
    AmoApiClient.prototype.getContactsCustomFieldById = function (customFieldId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = "/api/v4/contacts/custom_fields/".concat(customFieldId);
                        return [4, this.axios.get(url)];
                    case 1: return [2, (_a.sent()).data];
                }
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        url = "/api/v4/companies/".concat(companyId, "/links");
                        return [4, this.axios.get(url)];
                    case 1: return [2, (_a.sent()).data];
                }
            });
